...
public class MetaTileEntityAlloyKiln extends RecipeMapSteamMultiblockController {
    ...
    protected ICubeRenderer getFrontOverlay() {
        return Textures.ALLOY_SMELTER_OVERLAY; // Add appropriate overlay texture here
    }
