...
materialBuilder(31000, 'starmetal')
    .ingot().fluid()
    .blastTemp(2001, "MID")
    .components(material('schrabidium'), material('stellite_100'), material('saturnite'))
...
materialBuilder(31001, 'c_m_b_steel')
    .ingot().fluid()
    .blastTemp(2001, "MID")
    .components(material('saturnite'), material('uranium'), material('thorium'), material('oxygen'))
...
materialBuilder(31003, 'saturnite')
    .ingot().fluid()
    .blastTemp(2001, "MID")
    .components(material('platinum') * 4, material('phosphorus'), material('signalum'), material('advanced_alloy'))
...
materialBuilder(31753, 'advanced_alloy')
    .ingot().fluid()
    .rotorStats(120, 120, 31752)
    .flags('generate_plate', 'generate_rod', 'generate_gear', 'generate_dense', 'generate_spring', "generate_ring", "generate_bolt_screw", "generate_round")
    .color(0xe65f10)
    .blastTemp(1920, "MID")
    .fluidPipeProperties(800, 100, true, false, true, false)
    .components(material('annealed_copper'), material('redstone'), material('stainless_steel'))
.build()
